<?php
	...
	if(ISSET($_POST['save_admin'])){
		...
		if($v_admin > 0){
			...
			$conn->query("INSERT INTO `registered_users` SET `user_name` = '$username', `first_name` = '$firstname', last_name=' $lastname ', academic_year=' $academicyear ', `password` = '$password', email=' $email' ,gender='$gender'") or die($conn->error);
