...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
				<div class = "alert alert-info">Accounts/company</div>
				<button type = "button" id = "add_admin" class = "btn btn-success"><span class = "glyphicon glyphicon-plus"></span> Add New Company</button>
				...
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `company`") or die($conn->error);
								...
								<tr>
									...
									<td><?php echo $a_fetch['desc']?></td>
									<td><center><a href = "edit_company.php?company_id=<?php echo $a_fetch['company_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" name = "<?php echo $a_fetch['company_id']?>" data-toggle = "modal" data-target = "#delete_admin" class = "btn btn-danger id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
								</tr>
								<?php
									}
								?>
				...
				<div id = "a_form" style = "display:none;" class = "panel panel-default">
					<div  class = " panel-heading" >	
							<div class = "alert alert-success">Accounts/Company/Add new</div>
	...
	$(document).ready(function(){
		$('.id').on('click', function(){
			...
			$('.delete_admin').on('click', function(){
				window.location = 'delete_company_detail.php?company_id=' + $admin_id;
			});
		});
	});
</script>
