		...
		<div id = "sidecontent" class = "well pull-right">
						...
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td><a href="../upload/<?php echo $s_fetch['file']?>" targe="_blank" download><?php echo $s_fetch['first_name'] . ' ' . $s_fetch['last_name'] . "'s CV" ?></a></td>
				...
				<div class = "modal fade" id = "add_student" tabindex = "-1" role = "dialog" aria-labelledby = "myModallabel">
					<div class = "modal-dialog" role = "document">
						<div class = "modal-content ">
							<div class = "modal-body">
								<center><label class = "text-add">Successfully Added</label></center>
	...
	$(document).ready(function(){
		$('.id').on('click', function(){
			...
			$('.add_student').on('click', function(){
				window.location = 'add_intern.php?id=' + $id;
			});
		});
	});
</script>
