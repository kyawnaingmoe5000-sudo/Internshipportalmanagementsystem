...
INSERT INTO `activity` (`activity_id`, `title`, `description`, `company_name`, `start`, `end`, `month`, `year`) VALUES
(1, 'accountant', 'must a background on how to use pos like pastel','company1', '040917', '191117', 'Oct', '2017'),
(2, 'developer ', 'candidate must have background of front end and know at least one framework per language ','company2', '011217', '012318', 'Oct', '2017');
...
INSERT INTO `student` (`id`, `first_name`, `last_name`, `company_name`, `email`, `gender`, `file`) VALUES
(3, 'Kyaw', 'Kyaw','company1', 'Kyaw@gmail.com', 'male', 'A');
