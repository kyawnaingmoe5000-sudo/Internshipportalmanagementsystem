					...
					<div  class = " panel-heading" >	
						...
						<form method = "POST" action = "edit_activity_query.php?activity_id=<?php echo $f_activity['activity_id']?>">	
							...
							<div class = "form-group">
								...
								<input type = "text" value = "<?php echo $f_activity['company_name']?>" class = "form-control" name = "company_name" />
							</div>
							<div class = "form-group">
								<label>Available</label>
								<input type = "number" value = "<?php echo $f_activity['quantity']?>" class = "form-control" max="20" name = "quantity" required = "required"/>
							</div>
